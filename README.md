...
不同工具对 Skill 自动发现、局部编辑和规则加载的实现不同。当前版本属于 Alpha，欢迎提交真实兼容性测试结果。
...
| 维护方式 | 主要依靠日常手工更新 | 主动提议、快速维护、深度维护、压缩和健康报告 |
...
- [`evals/maintenance-cases.md`](evals/maintenance-cases.md)：是否采用局部写入、主动维护、非 Git 降级和腐烂抽查
